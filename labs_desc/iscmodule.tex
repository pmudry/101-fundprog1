...
\usepackage[a4paper, margin=1.8cm, bottom=1.5cm, top=2cm, includehead=false,includefoot=true,vcentering,$for(geometry)$$geometry$$sep$,$endfor$]{geometry}
...
\newcommand{\hesfootleft}
  {
    \begin{scriptsize}
      \textcolor{magenta}{Haute Ecole d'Ingénierie} · Industrie 21 · 1950 Sion 2\\
        +41 58 606 85 11 · \href{mailto:info.isc@hevs.ch}{info@hevs.ch} · \href{https://www.hevs.ch/isc}{www.hevs.ch}\par
    \end{scriptsize}
  }
...
\newcommand{\hesfootright}
  {
    \vspace{-2mm}
    \includegraphics[height=4.5mm]{figs/swissuniv.png}    
  }
...
\newcommand{\hesheadright}
  {
    \begin{footnotesize}
    $date$, \texttt{v$version$} -- {Hash \texttt{\shortcommit}}
    \end{footnotesize}
  }
...
\begin{tikzpicture}[remember picture,overlay]
	\node[anchor=north east,inner sep=0pt] at ($$(current page.north east)-(0.7cm,0.5cm)$$) {
...
\newcommand{\inMagenta}[1]{\textcolor{magenta}{\textbf{#1}}}

\ifthenelse{\equal{$document_lang$}{fr}}{
  \newcommand{\filiere}{Filière}
  \newcommand{\formation}{Formation}
  \newcommand{\axe}{Axe d'enseignement}
  \newcommand{\orientation}{Orientation}
  \newcommand{\annee}{Année académique}

  \newcommand{\volumeA}{Volume de}
  \newcommand{\volumeB}{travail}
  
  \newcommand{\volume}{Volume de travail}
  \newcommand{\teaching}{Enseignement}
  \newcommand{\perso}{Travail personnel}
  \newcommand{\total}{Total}
  \newcommand{\hours}{h}
  
  \newcommand{\unitName}{Nom de l'unité}
  \newcommand{\unitShortName}{Acronyme}
  \newcommand{\unitCode}{Code}

  \newcommand{\module}{Module}
  \newcommand{\type}{Type}
  \newcommand{\langue}{Langue}
  \newcommand{\resp}{Responsable(s)}
  \newcommand{\codemod}{Code du module}
  \newcommand{\ects}{Crédits ECTS}
  \newcommand{\anncursus}{Année cursus}

  \newcommand{\tableComment}{Unités d'enseignement, en périodes hebdomadaires (45 min)}

  \newcommand{\desc}{Organisation du module}
  \newcommand{\validHeader}{Validation du descriptif}
  \newcommand{\validText}{Ce descriptif a été validé le $date$ par Pierre-André Mudry, responsable de la filière ISC.}
  }{}
  
  \ifthenelse{\equal{$document_lang$}{de}}{
  \captionsetup[table]{name=Tabelle}
  \newcommand{\filiere}{Studiengang}
  \newcommand{\formation}{Bildung}
  \newcommand{\axe}{Unterrichtachse}
  \newcommand{\orientation}{Vertiefung}
  \newcommand{\annee}{Akademisches Jahr}

  \newcommand{\volumeA}{Arbeits-}
  \newcommand{\volumeB}{volumen}
  
  \newcommand{\teaching}{Ausbildung}
  \newcommand{\perso}{Persö. Arbeit}
  \newcommand{\total}{Total}
  \newcommand{\hours}{St.}

  \newcommand{\unitName}{Unterrichtseinheit}
  \newcommand{\unitShortName}{Acronym}
  \newcommand{\unitCode}{Kode}  

  \newcommand{\module}{Modul}
  \newcommand{\type}{Type}
  \newcommand{\langue}{Sprache(n)}
  \newcommand{\resp}{Modulverantwortung}
  \newcommand{\codemod}{Modulnuummer}
  \newcommand{\ects}{ECTS-Punkte}
  \newcommand{\anncursus}{Jahr}

  \newcommand{\tableComment}{Unterrichtseinheiten, pro Woche (45 min)}

  \newcommand{\desc}{Organisation des Moduls}
  \newcommand{\validHeader}{Validierung}
  \newcommand{\validText}{Validiert den $date$ bei Pierre-André Mudry, IKS Studiengangleiter.}
  }{}
        
  \ifthenelse{\equal{$document_lang$}{en}}{
  \newcommand{\filiere}{Degree programme}
  \newcommand{\formation}{Level}
  \newcommand{\axe}{Teaching axis}
  \newcommand{\orientation}{Major}
  \newcommand{\annee}{Academic year}

  \newcommand{\volumeA}{Work}
  \newcommand{\volumeB}{volume}
  \newcommand{\teaching}{Teaching}
  \newcommand{\perso}{Personal work}
  \newcommand{\total}{Total}
  \newcommand{\hours}{h}

  \newcommand{\unitName}{Teaching units}
  \newcommand{\unitShortName}{Acronym}
  \newcommand{\unitCode}{Code}  

  \newcommand{\module}{Module}
  \newcommand{\type}{Type}
  \newcommand{\langue}{Language(s)}
  \newcommand{\resp}{Responsible}
  \newcommand{\codemod}{Module code}
  \newcommand{\ects}{ECTS credits}
  \newcommand{\anncursus}{Year}

  \newcommand{\tableComment}{Teaching units, in weekly periods (45 min)}

  \newcommand{\desc}{Module organization}
  \newcommand{\validHeader}{Validation}
  \newcommand{\validText}{Validated on $date$ by Pierre-André Mudry, head of the ISC degree programme.}
  }{}
...
\begin{table}[h!]
  ...
  %\resizebox{\textwidth}{!}
  {
    \begin{tabular}{L{3.2cm}L{7.2cm}L{3cm}L{3.2cm}}      
      \inMagenta{\filiere} & $programme$ & \inMagenta{\formation} & $type$ \\
      \inMagenta{\axe} & $axis$ & \inMagenta{\orientation} & $minor$ \\
      \inMagenta{\annee} & $year_given$ \\    
    \end{tabular}    
  }
\end{table}
$endif$
...
\begin{table}[h!]
  ...
  %\resizebox{\textwidth}{!}
  {
    \begin{tabular}{L{3.2cm}L{7.2cm}L{3cm}L{3.2cm}}
      % \toprule
      \textbf{\module} & $module$ & \textbf{\codemod} & $code$ \\
      \textbf{\type} & $category$ & \textbf{\ects} & $ects$ \\
      \textbf{\langue} & {$for(language)$$language$$sep$, $endfor$} & \textbf{\annee} & $year$ \\
      \textbf{\resp} & {$for(responsible)$$responsible$$sep$, $endfor$}\\
    % \bottomrule
    \end{tabular}    
  }
\end{table}
...
% $endif$
% $endfor$
% Table of units throughout the years
\begin{table}[h!]
  \begin{center}        
    \begin{tabular}{lllccc|ccc|cc}
      \toprule
      \textbf{\unitCode} && \textbf{\unitName} & \textbf{S1} & \textbf{S2} & \textbf{SS1} & \textbf{S3} & \textbf{S4} & \textbf{SS2} & \textbf{S5} & \textbf{S6}\\      
      \midrule      
      $for(units)$
      $units.id$ & \texttt{\small $units.short_name$}& {{$units.name$}} & $units.periods_s1$ & $units.periods_s2$ & $units.periods_e1$ & $units.periods_s3$ & $units.periods_s4$ & $units.periods_e2$ & $units.periods_s5$ & $units.periods_s6$\\
      $endfor$      
      \bottomrule
    \end{tabular}
    \center{\caption{\tableComment{}}}
  \end{center}
\end{table}
\vspace{-1cm}
$else$
...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{l|lll}
      \multirowcell{2}{\volumeA{}\\\volumeB}&\textbf{\teaching} & \textbf{\perso} & \textbf{\total}\\
      & $hours_teaching$~\hours & $hours_personal$~\hours & $hours_total$~\hours            
    \end{tabular}
  \end{center}
\end{table}
\vspace{-5mm}
...
%   \marginpar{
%     \tcbox[colframe=green!50!white,colback=white,width=130pt]{
...
% \begin{center}
%   \tcbox[colframe=Cerulean!14,colback=Cerulean!10, enhanced, drop shadow southeast, width=.95\textwidth]{
%   \begin{minipage}{.44\textwidth}
%   \begin{description}[style=sameline, noitemsep, leftmargin=3cm]
%       \item[Coefficient] 7
%       \item[Périodes/sem.] 12 
%    \end{description}
%   \end{minipage}
%   \hfill
%   \begin{minipage}{.44\textwidth}
%   \begin{description}[style=sameline, noitemsep, leftmargin=3cm]
%       \item[Session] Printemps
%       \item[Enseignant] Pierre-André Mudry     
%    \end{description}
...
%   \tcbox[colframe=Cerulean!14,colback=Cerulean!10, enhanced, drop shadow southeast, width=7cm]{
%   \begin{minipage}{7cm}
%     \begin{description}[style=sameline, noitemsep, leftmargin=3cm]
...
% Machin pour dire que j'ai validé
\section{\validHeader{}}
\validText{}\\
